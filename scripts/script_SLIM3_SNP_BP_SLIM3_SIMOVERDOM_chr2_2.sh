...
rm script_SLIM3_SNP_BP_SLIM3_SIMOVERDOM_chr2_2_trozo.sh.*
...
cp recombination_map_chr2_2trozo_escalado.txt /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/
cp shell_F_values_2_2 /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/shell_F_values
