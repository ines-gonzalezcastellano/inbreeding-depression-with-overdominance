...
rm script_SLIM3_SNP_BP_SLIM3_SIMOVERDOM_chr4_1_trozo.sh.*
...
cp recombination_map_chr4_1trozo_escalado.txt /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/
cp shell_F_values_4_1 /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/shell_F_values
