...
rm script_SLIM3_SNP_BP_SLIM3_SIMOVERDOM_chr19.sh.*
...
cp recombination_map_chr19.txt /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/
cp shell_F_values_19 /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/shell_F_values
