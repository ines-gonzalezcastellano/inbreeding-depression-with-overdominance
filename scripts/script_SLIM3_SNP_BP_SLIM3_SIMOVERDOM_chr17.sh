...
rm script_SLIM3_SNP_BP_SLIM3_SIMOVERDOM_chr17.sh.*
...
cp recombination_map_chr17.txt /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/
cp shell_F_values_17 /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/shell_F_values
