...
rm script_SLIM3_SNP_BP_SLIM3_SIMOVERDOM_chr1_2_trozo.sh.*
...
cp recombination_map_chr1_2trozo_escalado.txt /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/
cp shell_F_values_1_2 /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/shell_F_values
