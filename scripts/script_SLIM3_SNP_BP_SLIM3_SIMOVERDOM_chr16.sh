...
rm script_SLIM3_SNP_BP_SLIM3_SIMOVERDOM_chr16.sh.*
...
cp recombination_map_chr16.txt /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/
cp shell_F_values_16 /state/partition1/pilarSLIM$INPUT/$SLURM_JOBID/shell_F_values
